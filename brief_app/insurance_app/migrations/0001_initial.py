    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('smoker', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=10)),
                ('region', models.CharField(blank=True, choices=[('Northeast', 'Northeast'), ('Northwest', 'Northwest'), ('Southeast', 'Southeast'), ('Southwest', 'Southwest')], max_length=10)),
